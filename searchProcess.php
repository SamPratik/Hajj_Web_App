...
<?php
	...
	$i = 0;
	$selectSearchName = "SELECT id,bc,nid,full_name_eng,grp_id,curr_district FROM priligrim_info WHERE full_name_eng LIKE '%{$searchTermName}%' ORDER BY id DESC";
...
<?php
	...
	/*------------------------------------------------------------------------------------------
	[
    	{"id": "2","nid": "201414011","bc": "23586","name": "Samiul Alim Pratik","grp": "2","currDist": "Dhaka"},
        {"id": "3","nid": "201414011","bc": "23586","name": "FR Affan","grp": "3","currDist": "Bogra"},
        {"id": "10","nid": "201414011","bc": "23586","name": "Moumita","grp": "1","currDist": "Dhaka"}
    ]
	------------------------------------------------------------------------------------------*/
